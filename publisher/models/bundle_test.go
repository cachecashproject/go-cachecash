...
var (
	bundleDBTypes = map[string]string{`ID`: `integer`, `EscrowID`: `integer`, `BlockID`: `integer`, `Raw`: `bytea`, `RequestSequenceNo`: `numeric`, `ClientPublicKey`: `character varying`, `Objectid`: `character varying`}
	_             = bytes.MinRead
)
